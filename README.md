...
# 📊 GitHub Stats
It's not much. Take into consideration the fact that I committed to my [capstone project](https://github.com/kiryusec/voz-do-aluno) under my [alternative account](https://github.com/Havoc-DLL) as well.<br>(If you don't see any stats below this text, the service is temporarily offline).<br>
